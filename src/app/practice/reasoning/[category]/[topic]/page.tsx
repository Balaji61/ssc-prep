...
export default function ReasoningPracticeSetupPage() {
  ...
  useEffect(() => {
    async function loadQuestionCount() {
      try {
        ...
        console.log("REASONING AVAILABLE QUESTIONS:", availableCount);
  ...
  function startPractice() {
    ...
    const url =
      `/practice/questions` +
      `?subject=${encodeURIComponent("reasoning")}` +
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold capitalize text-blue-900 sm:text-4xl">
            {topic}
          </h1>
